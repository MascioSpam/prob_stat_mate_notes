...
La probabilità che si verifichi un evento x condizionata dall'evento ![E](../gif/E.gif), è costituita dal numero di realizzazioni di x (Nx) sul totale di osservazioni (N), dalle quali si escludono quelle per cui il risultato ![notinE](../gif/notinE.gif), denotiamo con ![NE](../gif/NE.gif), il numero di realizzazione ![inE](../gif/inE.gif)
